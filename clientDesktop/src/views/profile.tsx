...
import { setPublic, setPrivate } from "../utils";
  ...
  return (
    <>
      ...
      <input
        ...
        className="block bg-transparent border-2 border-zinc-900 text-center p-2 my-4 mx-auto rounded-md focus:ring-2 focus:outline-none focus:ring-zinc-700"
      />
      <button className="block mx-auto py-3 px-6 mb-6 bg-gray-700 hover:bg-gray-800 text-sm text-white font-bold rounded-md transition duration-200">
        Save Changes
      </button>
      {data.private ? (
        <div>
